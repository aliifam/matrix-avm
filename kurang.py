...
def kurangmatriks():
    while True:
        print()
        print("---------------------------------------------")
        print("SELAMAT DATANG DI PROGRAM PENGURANGAN MATRIKS")
        print("---------------------------------------------")
        print()
        print("alert : syarat dua matriks dapat dikurangi yaitu keduanya harus memiliki ordo yang sama")
        print()
        ...
        while True:
            ...
            if column1 != column2 or row1 != row2:
                ...
                print()
                print("alert : untuk mengurangi dua matriks pastikan keduanya memiliki ordo metriks yang sama")
                continue
            else:
                break
        ...
        print()
        print("--------------------------------")
        print("HASIL PENGURANGAN MATRIKS ADALAH")
        print("--------------------------------")
        print()
